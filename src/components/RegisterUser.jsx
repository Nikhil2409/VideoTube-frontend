  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      if (error.response) {
        ...
        setError(
          "An error occurred with Google authentication. Please try again."
        );
      }
    } finally {
      setIsLoading(false);
    ...
    <div className="flex h-screen w-full">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 md:px-16 relative">
        ...
        <div className="w-full max-w-md">
          ...
          {error && (
            <p className="text-center text-sm mb-4 text-red-600">{error}</p>
          )}
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div className="mb-6 flex justify-center">
              <div className="relative">
                <div
                  className={`w-20 h-20 rounded-full overflow-hidden ${avatarPreview ? "" : "bg-gray-100"} flex items-center justify-center border-2 border-blue-400`}
                >
                  {avatarPreview ? (
                    <img
                      src={avatarPreview}
            ...
            <div className="mb-6">
              ...
              <div
                className={`w-full h-16 rounded-lg overflow-hidden relative ${coverPreview ? "" : "bg-gray-100 border-2 border-dashed border-gray-300"}`}
              >
                {coverPreview ? (
                  <img
                    src={coverPreview}
