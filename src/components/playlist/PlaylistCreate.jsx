            ...
            {videos.length === 0 ? (
              <div className="text-center py-16 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Click "Add Videos" to start building your playlist
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                {videos.map((video, index) => (
                  <div
                    key={video.id}
                    className="flex items-center bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-indigo-300 transition-colors"
                  >
                    <div className="mr-3 text-gray-500 font-bold">
                      {index + 1}
                    </div>
