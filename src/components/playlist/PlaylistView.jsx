...
const PlaylistView = () => {
  ...
  const handleDrop = async (e, dropIndex) => {
    ...
    setError(
      "Reordering saved locally. Refresh will revert to original order."
    );
  };
  ...
  const fetchVideosNotInPlaylist = async () => {
    ...
    try {
      ...
      const response = await api.get(
        `/api/v1/videos/user/${userId}/not-in-playlist/${playlistId}`,
        {}
      );
                ...
                <div className="divide-y divide-gray-200">
                  {videos.map((video, index) => (
                    ...
                    >
                      ...
                      <div
                        className="mr-4 w-32 flex-shrink-0"
              ...
              {availableVideos.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  <p className="text-lg font-medium">
                    All available videos are already in your playlist
                  </p>
                  <p className="mt-1">
                    Upload more videos or create a new playlist
                  </p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        <div className="w-2/3 p-3 flex flex-col">
                          ...
                          <div className="mt-auto">
                            <button className="w-full py-1 px-2 rounded text-sm font-medium bg-indigo-600 hover:bg-indigo-700 text-white">
                              Add to Playlist
                            </button>
                          </div>
                        </div>
